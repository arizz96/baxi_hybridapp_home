...
class BaxiDataUpdateCoordinator(DataUpdateCoordinator):
    ...
    async def _async_update_data(self) -> bool:
        ...
        # Un'unica richiesta "all-in-one" per tutte le metriche wired
        # dall'integrazione (SIMPLE_METRICS + ENERGY_SENSOR_TYPES + scheduler
        # sanitario), al posto di una richiesta separata per ciascuna.
        # Popola api._latest_metric_values, letta dai tre dispatcher sotto
        # senza ulteriori chiamate HTTP.
